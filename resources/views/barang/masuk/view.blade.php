...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-primary" data-toggle="modal" data-target="#dataMasukModal">
            Tambah Data Masuk
        </button>
    </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$data->qty}}</td>
                            <td colspan="2">
                                <button class="btn btn-warning" data-toggle="modal" data-target="#editDataMasukModal" data-id="{{ $data->id }}"
                                ...
                                <a href="{{ route('masuk.destroy', $data->id) }}" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
...
<!-- Modal Add-->
<div class="modal fade" id="dataMasukModal" tabindex="-1" role="dialog" aria-labelledby="dataMasukModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="dataMasukModalLabel">Tambah Data Masuk</h5>
...
<!-- Edit Modal -->
<div class="modal fade" id="editDataMasukModal" tabindex="-1" role="dialog" aria-labelledby="editDataMasukModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDataMasukModalLabel">Edit Data Masuk</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                <button type="button" class="btn btn-warning" id="saveEditButton">Simpan Perubahan</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $('#editDataMasukModal').on('show.bs.modal', function(event) {
            ...
            var actionUrl = '{{ route("masuk.update", ":id") }}';
